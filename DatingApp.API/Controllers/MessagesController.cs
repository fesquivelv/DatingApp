...
namespace DatingApp.API.Controllers {
    ...
    public class MessagesController : ControllerBase {
        ...
        public async Task<IActionResult> createMessage(int userId, MessageForCreationDto messageForCreationDto) {
            var sender = await _repo.GetUser(userId);//Autommaper automaticamente agarra valores de este objeto
            ...
            var recipient = await _repo.GetUser(messageForCreationDto.RecipientId);//Autommaper automaticamente agarra valores de este objeto
        ...
        public async Task<IActionResult> DeleteMessage(int id, int userId) {
            ...
            throw new Exception("Error deleting the mesage");
